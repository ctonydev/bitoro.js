...
const pool: LiquidityPool = {
  ...
  blpPriceLowerBound: new BigNumber('0.9'),
  blpPriceUpperBound: new BigNumber('1.1'),
...
const assets: Asset[] = [
  {
    ...
    bitoroTokenAddress: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee1',
  ...
  },
  {
    ...
    bitoroTokenAddress: '0xccccccccccccccccccccccccccccccccccccccc1',
    referenceOracleType: 0,
...
describe('closePosition', function () {
  ...
  const successCases: Case[] = [
    {
      ...
      expectedOutput: {
        ...
        bitoroTokenTransferred: new BigNumber('0')
      }
    },
    {
  ...
  successCases.forEach(element => {
    it(element.name, function () {
      ...
      expect(result.bitoroTokenTransferred).toApproximate(element.expectedOutput.bitoroTokenTransferred)
    })
  })
})
