...
export const CHAIN_ID_TO_BCB_ADDRESS: { [chainID: number]: string } = {
  // arb1
  42161: '0x4e352cf164e64adcbad318c3a1e222e9eba4ce42'
}

export const CHAIN_ID_TO_BITORO_ADDRESS: { [chainID: number]: string } = {
  // arb1
  42161: '0x8BB2Ac0DCF1E86550534cEE5E9C8DED4269b679B'
}

export const CHAIN_ID_TO_BLP_ADDRESS: { [chainID: number]: string } = {
  // arb1
...
export const CHAIN_ID_TO_BLP_FEE_REWARD_TRACKER_ADDRESS: { [chainID: number]: string } = {
  // arb1
...
export const CHAIN_ID_TO_BLP_VESTER_ADDRESS: { [chainID: number]: string } = {
  // arb1
  42161: '0xBCF8c124975DE6277D8397A3Cad26E2333620226'
}

export const CHAIN_ID_TO_BITORO_VESTER_ADDRESS: { [chainID: number]: string } = {
  // arb1
