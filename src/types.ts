...
export enum InsufficientLiquidityType {
  BitoroRemoveLiquidityExceedsCurrentAsset,
...
export interface LiquidityPool {
  ...
  blpPriceLowerBound: BigNumber // safeguard against blp price attacks
  blpPriceUpperBound: BigNumber // safeguard against blp price attacks
}
...
export interface AssetConfig {
  ...
  bitoroTokenAddress: string // bitoroToken.address. all stable coins share the same bitoroTokenAddress
