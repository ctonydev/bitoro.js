...
export declare namespace ProxyFactory {
  ...
  export type BitoroOrderParamsStruct = {
  ...
  export type BitoroOrderParamsStructOutput = [
    string,
    BigNumber,
    BigNumber,
    BigNumber,
...
export interface ProxyFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "setBitoroOrderBook",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface ProxyFactory extends BaseContract {
  ...
  functions: {
    ...
    openPositionV3(
      args: ProxyFactory.OpenPositionArgsV2Struct,
      bitoroParams: ProxyFactory.BitoroOrderParamsStruct,
      bitoroValue: PromiseOrValue<BigNumberish>,
      overrides?: PayableOverrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setBitoroOrderBook(
      bitoroOrderBook: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "BitoroCall(address,uint256,bytes)"(
      target?: null,
      value?: null,
      data?: null
    ): BitoroCallEventFilter;
