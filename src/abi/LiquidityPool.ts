...
export interface LiquidityPoolInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "redeemBitoroToken",
...
export type IssueBitoroTokenEvent = TypedEvent<
  ...
  { tokenId: number; isStable: boolean; bitoroTokenAmount: BigNumber }
>;
...
export type RedeemBitoroTokenEvent = TypedEvent<
  [string, number, BigNumber],
  { trader: string; tokenId: number; bitoroTokenAmount: BigNumber }
>;
...
export type SetBlpPriceRangeEventFilter =
  TypedEventFilter<SetBlpPriceRangeEvent>;
...
export interface LiquidityPool extends BaseContract {
  ...
  functions: {
    ...
    redeemBitoroToken(
      trader: string,
      tokenId: BigNumberish,
      bitoroTokenAmount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    removeLiquidity(
      trader: string,
      blpAmount: BigNumberish,
      tokenId: BigNumberish,
      tokenPrice: BigNumberish,
      blpPrice: BigNumberish,
      currentAssetValue: BigNumberish,
    ...
    setEmergencyNumbers(
      newBlpPriceLowerBound: BigNumberish,
      newBlpPriceUpperBound: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "IssueBitoroToken(uint8,bool,uint96)"(
      tokenId?: BigNumberish | null,
      isStable?: null,
      bitoroTokenAmount?: null
    ): IssueBitoroTokenEventFilter;
    IssueBitoroToken(
      tokenId?: BigNumberish | null,
      isStable?: null,
      bitoroTokenAmount?: null
    ...
    "RedeemBitoroToken(address,uint8,uint96)"(
      trader?: null,
      tokenId?: null,
      bitoroTokenAmount?: null
    ): RedeemBitoroTokenEventFilter;
    RedeemBitoroToken(
      trader?: null,
      tokenId?: null,
      bitoroTokenAmount?: null
    ...
    "SetBlpPriceRange(uint96,uint96)"(
      newLowerBound?: null,
      newUpperBound?: null
    ): SetBlpPriceRangeEventFilter;
    SetBlpPriceRange(
      newLowerBound?: null,
      newUpperBound?: null
    ): SetBlpPriceRangeEventFilter;
